...
while True:
    ...
    if snake.get_position() == applePosition: # See if the apple and snake are on the same position on the grid
        snake.grow() # Make the snake grow
        applePosition = snake.get_new_apple_position() # Create another apple elsewhere
    ...
    if snake.has_collided_with_self():
        ...
        snake.reset()
        applePosition = snake.get_new_applePosition() # Create another apple elsewhere
